                                        ...
                                        public boolean onMenuItemClick(MenuItem item) {
                                            switch (item.getItemId()) {
                                                case R.id.post_view_menu:
                                                    Intent viewIntent = new Intent(GroupDetailsActivity.this, SpecificPostActivity.class);
                                                ...
                                                case R.id.post_delete_menu:
                                                    ...
                                                    AlertDialog.Builder builder = new AlertDialog.Builder(GroupDetailsActivity.this, R.style.AlertDialogTheme);
    ...
    public class ViewEditGroupDialog{
        public void showDialog(Activity activity) {
            ...
            if (!groupType.getText().toString().equals(null)) {
                int spinnerPosition = staticAdapter.getPosition(groupType.getText().toString());
