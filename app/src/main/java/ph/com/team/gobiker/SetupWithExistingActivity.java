...
public class SetupWithExistingActivity extends AppCompatActivity {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    if(dataSnapshot.hasChild("profileimage")) {
                        ...
                        Picasso.with(SetupWithExistingActivity.this).load(image).placeholder(R.drawable.profile).into(ProfileImage);
                    }
                    else{
                        Toast.makeText(SetupWithExistingActivity.this,"Please select profile image first...",Toast.LENGTH_SHORT).show();
                    }
                }
            }
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    filePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            Toast.makeText(SetupWithExistingActivity.this, "Image uploaded successfully to storage", Toast.LENGTH_SHORT).show();
                            UsersRef.child("profileimage").setValue(downloadUrl)
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful()){
                                                Intent selfIntent = new Intent(SetupWithExistingActivity.this, SetupWithExistingActivity.class);
                                                startActivity(selfIntent);
                                                Toast.makeText(SetupWithExistingActivity.this,"Profile Image stored to firebase storage successfully .",Toast.LENGTH_SHORT).show();
                                            }
                                            else{
                                                Toast.makeText(SetupWithExistingActivity.this,"Error occurred:"+task.getException().getMessage(),Toast.LENGTH_SHORT).show();
                                            }
                                            loadingBar.dismiss();
                                        }
                                    });
            ...
            UsersRef.updateChildren(userMap).addOnCompleteListener(new OnCompleteListener() {
                ...
                public void onComplete(@NonNull Task task) {
                    if (task.isSuccessful()){
                        ...
                        Toast.makeText(SetupWithExistingActivity.this,"Your account is created successfully.",Toast.LENGTH_LONG).show();
                    }
                    else{
                        String message = task.getException().getMessage();
                        Toast.makeText(SetupWithExistingActivity.this,"Error Occurred:"+message,Toast.LENGTH_SHORT).show();
                    }
                    loadingBar.dismiss();
                }
            });
    ...
    private void SendUserToMainActivity() {
        Intent mainIntent = new Intent(SetupWithExistingActivity.this,NavActivity.class);
